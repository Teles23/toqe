...
- **Dados fake do painel direito** removidos: pílula "248 barbearias online agora", depoimento atribuído a "Marcus Andrade · Barbearia Urban", rodapé técnico "v2.4 · sincronizado há 2s", linha "USADO POR · URBAN · CORTE FINO · NAVALHA".
- **Painel direito** agora exibe headline institucional neutra + mini-card de agenda com rótulos genéricos demonstrativos (sem nomes inventados).
