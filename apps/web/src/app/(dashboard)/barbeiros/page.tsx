...
const BARBEIROS: Barbeiro[] = [
  ...
  },
  {
    ...
    nome: "Lucas Pereira",
    initial: "L",
    telefone: "(71) 99999-1002",
    especialidade: "Degradê + Pigmentação",
    estado: "idle",
    atendimentosHoje: 4,
    atendimentosMes: 98,
    faturamentoMes: 7840,
    ...
    diasSemana: ["Ter", "Qua", "Qui", "Sex", "Sáb"],
  },
  {
    id: 3,
    nome: "Felipe Matos",
    initial: "F",
    telefone: "(71) 99999-1003",
    especialidade: "Sobrancelha + Acabamento",
    estado: "active",
    atendimentosHoje: 5,
    atendimentosMes: 86,
    faturamentoMes: 3440,
    ticketMedio: 40,
    avaliacao: 4.7,
    clienteAtual: "Ana Costa",
    servicoAtual: "Sobrancelha",
    progressoAtual: 45,
    horarioEntrada: "08:00",
    diasSemana: ["Seg", "Qua", "Sex", "Sáb"],
  },
  {
    id: 4,
    nome: "Rodrigo Costa",
    initial: "R",
    telefone: "(71) 99999-1004",
    especialidade: "Afro + Tranças",
    estado: "off",
    atendimentosHoje: 0,
    atendimentosMes: 74,
    faturamentoMes: 4440,
        ...
        {b.estado === "active" && b.clienteAtual && (
          ...
          >
            <span
              ...
              style={{ color: "var(--status-success)", opacity: 0.7 }}
            >
              Atendimento atual
            </span>
            <span
              ...
              <div>
                ...
                >
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    animate={{ width: `${b.progressoAtual}%` }}
          ...
          {b.estado === "active" && b.clienteAtual && (
            <div className="mb-2">
              <span
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                {b.clienteAtual} · {b.servicoAtual}
              </span>
              {b.progressoAtual !== undefined && (
                <div
                  className="mt-1 rounded-full overflow-hidden"
                  style={{ height: 2, background: "var(--border-default)" }}
                >
                  <motion.div
                    className="h-full rounded-full"
                    style={{ background: "var(--status-success)" }}
