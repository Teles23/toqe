...
const ATIVIDADE_RECENTE = [
  { tipo: "confirmado", texto: "Pedro Santos confirmou 09:00", tempo: "2min",  cor: "var(--status-success)" },
  { tipo: "novo",       texto: "Novo agendamento — Rafael 14:00", tempo: "8min",  cor: "var(--status-info)"    },
  { tipo: "atrasado",   texto: "João Silva atrasado — 08:30",  tempo: "12min", cor: "var(--status-error)"   },
  { tipo: "encaixe",    texto: "Horário encaixado — Carlos 13:00", tempo: "18min", cor: "var(--status-warning)" },
  { tipo: "concluido",  texto: "Diego Mendes — Corte concluído", tempo: "34min", cor: "var(--status-success)" },
  { tipo: "avaliacao",  texto: "Marco Oliveira deixou 5 estrelas", tempo: "1h", cor: "var(--status-warning)"  },
];

const BARBEIROS_STATUS = [
  { nome: "Carlos",  initial: "C", estado: "active" as const, cliente: "João Silva",   servico: "Corte",         pct: 68 },
  { nome: "Lucas",   initial: "L", estado: "idle"   as const, cliente: null,           servico: null,            pct: 0  },
  { nome: "Felipe",  initial: "F", estado: "active" as const, cliente: "Ana Costa",    servico: "Sobrancelha",   pct: 45 },
];
...
function BarbeiroLive({ b }: { b: typeof BARBEIROS_STATUS[0] }): React.JSX.Element {
  const stateColor = b.estado === "active" ? "var(--status-success)" : "var(--text-muted)";

  return (
    <div
      className="flex items-center gap-3 py-2.5 px-3 rounded-xl relative overflow-hidden"
      style={{
        background: b.estado === "active" ? "rgba(29,185,84,0.04)" : "transparent",
        ...
        {b.estado === "active" && b.cliente ? (
          <>
            ...
            <div
              ...
              style={{ height: 2, background: "var(--border-default)", width: "100%" }}
            >
              <motion.div
...
export default function Dashboard(): React.JSX.Element {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5">
      ...
      >
        ...
        >
          {[
            ...
            <div key={stat.label} className="px-5 py-3 flex flex-col gap-0.5"
        ...
        >
          ...
          <div className="px-4 py-4" style={{ height: 200 }}>
            <ClientOnlyChart>
              ...
              <AreaChart data={FATURAMENTO_SEMANA} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
                <defs>
                ...
                <Area
                  ...
                  fill="url(#gradFat)"
                  dot={false}
                  activeDot={{ r: 4, fill: "#1DB954", stroke: "var(--bg-card)", strokeWidth: 2 }}
                />
              </AreaChart>
              </ResponsiveContainer>
            </ClientOnlyChart>
        ...
        >
          ...
          >
            ...
            <span
              ...
              style={{ background: "rgba(77,163,255,0.1)", color: "var(--status-info)" }}
            >
              Ao vivo
            </span>
          </div>
      ...
      >
        {[
          { label: "Novo agendamento", icon: Calendar,  href: "/agenda",        color: "var(--primary)" },
          { label: "Cadastrar cliente", icon: Users,     href: "/clientes",      color: "var(--status-info)" },
          { label: "Ver relatório",     icon: BarChart3, href: "/relatorios",    color: "var(--status-success)" },
          { label: "Configurações",     icon: Scissors,  href: "/configuracoes", color: "var(--text-secondary)" },
        ].map((action) => {
